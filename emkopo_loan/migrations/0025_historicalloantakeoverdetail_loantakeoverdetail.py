# Generated by Django 5.1 on 2024-09-17 21:13
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("emkopo_loan", "0024_historicalloanrestructuringrequest_and_more"),
        migrations.swappable_dependency(settings.AUTH_USER_MODEL),
    ]

    operations = [
        migrations.CreateModel(
            name="HistoricalLoanTakeoverDetail",
            fields=[
                (
                    "revision",
                ...
                (
                    ...
                    models.CharField(max_length=45, verbose_name="Payment Reference Number"),
                ),
                (
                    "TotalPayoffAmount",
                    models.DecimalField(
                ...
                ("LastPayDate", models.DateTimeField(verbose_name="Last Payment Date")),
            ...
            options={
                "verbose_name": "historical Loan Takeover Detail",
                "verbose_name_plural": "historical Loan Takeover Detail",
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["modified", "created"], name="emkopo_loan_modifie_c61a63_idx"
                    ),
                    models.Index(
                        fields=["user_modified", "user_created"],
                        name="emkopo_loan_user_mo_8cae6b_idx",
                    ),
                ],
            },
        ),
