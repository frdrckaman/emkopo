...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("emkopo_loan", "0022_historicalloanpayoffbalancerequest_and_more"),
        migrations.swappable_dependency(settings.AUTH_USER_MODEL),
    ]

    operations = [
        migrations.CreateModel(
            name="HistoricalLoanSettlementBalanceResponse",
            fields=[
                (
                    "revision",
                ...
                ("LastPayDate", models.DateTimeField(verbose_name="Last Pay Date")),
            ...
            options={
                "verbose_name": "historical Settlement Balance Response",
                "verbose_name_plural": "historical Settlement Balance Responses",
        ...
        migrations.CreateModel(
            name="LoanSettlementBalanceResponse",
            fields=[
                (
                    "revision",
                    django_revision.revision_field.RevisionField(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["modified", "created"], name="emkopo_loan_modifie_b0478c_idx"
                    ),
                    models.Index(
                        fields=["user_modified", "user_created"],
                        name="emkopo_loan_user_mo_46ba93_idx",
                    ),
                ],
            },
        ),
