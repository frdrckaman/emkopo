# Generated by Django 5.1 on 2024-10-13 13:48
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("emkopo_loan", "0043_alter_fullloanrepaymentnotification_applicationnumber_and_more"),
        migrations.swappable_dependency(settings.AUTH_USER_MODEL),
    ]

    operations = [
        migrations.CreateModel(
            name="FullLoanRepaymentRequest",
            fields=[
                (
                    "revision",
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["modified", "created"], name="emkopo_loan_modifie_dc2781_idx"
                    ),
                    models.Index(
                        fields=["user_modified", "user_created"],
                        name="emkopo_loan_user_mo_0ef41e_idx",
                    ),
                ],
            },
        ),
        migrations.CreateModel(
            name="HistoricalFullLoanRepaymentRequest",
            fields=[
                (
                    "revision",
                    django_revision.revision_field.RevisionField(
            ...
            options={
                "verbose_name": "historical Ful Loan Repayment Request",
                "verbose_name_plural": "historical Full Loan Repayment Requests",
