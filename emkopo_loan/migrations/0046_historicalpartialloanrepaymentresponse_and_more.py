...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ("emkopo_loan", "0045_historicalpartialloanrepaymentrequest_and_more"),
        migrations.swappable_dependency(settings.AUTH_USER_MODEL),
    ]

    operations = [
        migrations.CreateModel(
            name="HistoricalPartialLoanRepaymentResponse",
            fields=[
                (
                    "revision",
            ...
            options={
                "verbose_name": "historical Partial Loan Repayment Response",
                "verbose_name_plural": "historical Partial Loan Repayment Response",
        ...
        migrations.CreateModel(
            name="PartialLoanRepaymentResponse",
            fields=[
                (
                    "revision",
                    django_revision.revision_field.RevisionField(
            ...
            options={
                ...
                "indexes": [
                    models.Index(
                        fields=["modified", "created"], name="emkopo_loan_modifie_929d89_idx"
                    ),
                    models.Index(
                        fields=["user_modified", "user_created"],
                        name="emkopo_loan_user_mo_418640_idx",
                    ),
                ],
            },
        ),
