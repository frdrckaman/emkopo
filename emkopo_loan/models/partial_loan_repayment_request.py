...
class PartialLoanRepaymentRequest(BaseUuidModel):
    ...
    AmountToPay = models.DecimalField(
    ...
    class Meta(BaseUuidModel.Meta):
        verbose_name = "Partial Loan Repayment Request"
        verbose_name_plural = "Partial Loan Repayment Requests"
